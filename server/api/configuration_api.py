...
def configuration_endpoints(app: FastAPI, pipeline_server: PipelineServer, api_base_url: str):
    ...
    async def create_configuration(
        ...
        return await config_manager.create_new_configuration(body.type, body.name, body.description, user)
    ...
    async def get_configuration(configuration_id: str, _=Depends(AUTH_REQUIREMENTS_VIEW)) -> ConfigurationDto:
        return await config_manager.get_configuration(configuration_id)
    ...
    async def update_configuration(
        ...
        return await config_manager.update_configuration(configuration_id, configuration, user)
    ...
    async def get_version(
        ...
        return await config_manager.get_versions(configuration_id, state, name, sort, limit, offset)

    @app.post(api_base_url + "/configuration/{configuration_id}/version")
    async def create_version(
        body: CreateConfigurationDto, user=Depends(AUTH_REQUIREMENTS_EDIT)
    ) -> ConfigurationVersionDto:
        return await config_manager.create_new_version(body.type, body.name, body.description, body.baseVersionId, user)
    ...
    async def get_version(
        ...
        return await config_manager.get_version(configuration_id, version_id)
